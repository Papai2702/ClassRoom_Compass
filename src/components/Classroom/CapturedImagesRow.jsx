...
const CapturedImagesRow = ({ images }) => {
  return (
    <motion.div
      ...
      className="mt-4 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/10 shadow-lg p-3 w-full lg:w-fit lg:min-w-[75%] mx-auto overflow-auto"
    >
        ...
        {images?.length > 0 ? (
          images.map((img, index) => (
            ...
            >
              ...
              />
              <div className="absolute bottom-1 right-1 bg-black/50 text-xs px-1 rounded z-10">
