...
const Nav = () => {
  ...
  return (
    <div>
      {/* Navbar */}
      <header className="w-full md:w-3/4 lg:w-1/2 mx-auto py-2 px-4 md:px-10 flex justify-between items-center shadow-lg border-1 border-gray-300 rounded-[50px] relative">
        <div className="text-lg md:text-xl font-bold text-[#6c90c3]">LOGO HERE</div>
